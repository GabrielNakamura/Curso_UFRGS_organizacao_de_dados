...
Como já comentado na [introdução ao Git](https://gabrielnakamura.github.io/Curso_UFRGS_organizacao_de_dados/Intro_Git.html), cada vez que um arquivo dentro de uma pasta observada pelo Git é modificada ele irá aparecer na aba *Git* do seu RStudio. Como mostrado nessa figura:

![Git - o olho que tudo vê](/Users/gabrielnakamura/OneDrive/Aulas/Disciplina_ppgEco/Curso_UFRGS_organizacao_de_dados/Figs_presentation/Aba_Git_Rstudio.png)
